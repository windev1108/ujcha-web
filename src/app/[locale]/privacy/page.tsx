  ...
  const SECTIONS = [
    {
      ...
      title: t("ps1_title"),
      content: [
        { subtitle: t("ps1_b1_sub"), body: t("ps1_b1_body") },
        { subtitle: t("ps1_b2_sub"), body: t("ps1_b2_body") },
        { subtitle: t("ps1_b3_sub"), body: t("ps1_b3_body") },
      ],
    },
    {
      id: "su-dung",
      title: t("ps2_title"),
      content: [
        { subtitle: t("ps2_b1_sub"), body: t("ps2_b1_body") },
        { subtitle: t("ps2_b2_sub"), body: t("ps2_b2_body") },
        { subtitle: t("ps2_b3_sub"), body: t("ps2_b3_body") },
        { subtitle: t("ps2_b4_sub"), body: t("ps2_b4_body") },
      ],
    },
    {
      id: "chia-se",
      title: t("ps3_title"),
      content: [
        { subtitle: t("ps3_b1_sub"), body: t("ps3_b1_body") },
        { subtitle: t("ps3_b2_sub"), body: t("ps3_b2_body") },
        { subtitle: t("ps3_b3_sub"), body: t("ps3_b3_body") },
      ],
    },
    {
      id: "bao-ve",
      title: t("ps4_title"),
      content: [
        { subtitle: t("ps4_b1_sub"), body: t("ps4_b1_body") },
        { subtitle: t("ps4_b2_sub"), body: t("ps4_b2_body") },
      ],
    },
    {
      id: "quyen",
      title: t("ps5_title"),
      content: [
        { subtitle: t("ps5_b1_sub"), body: t("ps5_b1_body") },
        { subtitle: t("ps5_b2_sub"), body: t("ps5_b2_body") },
        { subtitle: t("ps5_b3_sub"), body: t("ps5_b3_body") },
      ],
    },
    {
      id: "luu-tru",
      title: t("ps6_title"),
      content: [
        { subtitle: t("ps6_b1_sub"), body: t("ps6_b1_body") },
        { subtitle: t("ps6_b2_sub"), body: t("ps6_b2_body") },
      ],
    },
    {
      id: "lien-he",
      title: t("ps7_title"),
      content: [
        { subtitle: t("ps7_b1_sub"), body: t("ps7_b1_body") },
      ],
    },
  ];
